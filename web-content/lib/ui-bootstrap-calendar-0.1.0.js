...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    ...
    '      <td ng-repeat="dt in row" class="calendar-item text-center">\n' +
    '           <div ng-class="{muted: dt.secondary}">{{dt.label}}</div>' + 
    // "        <button type=\"button\" style=\"width:100%;\" class=\"btn btn-large\" ng-class=\"{'btn-info': dt.selected}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\"><span ng-class=\"{muted: dt.secondary}\">{{dt.label}}</span></button>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
